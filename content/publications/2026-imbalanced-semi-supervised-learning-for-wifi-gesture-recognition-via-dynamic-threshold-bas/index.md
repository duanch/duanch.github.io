...
links:
  - type: pdf
    url: "/papers/2026-imbalanced-semi-supervised-learning-for-wifi-gesture-recognition-via-dynamic-threshold-bas.pdf"
hugoblox:
  ids:
...
WiFi sensing advancements facilitate the capture of human gestures from wireless signals, ensuring both
...
Q. Feng, C. Duan, J. Xue, C. Li, F. Huang, X. Zhang, J. Weng, and P. S. Yu, “Imbalanced Semi-Supervised Learning for WiFi Gesture Recognition via Dynamic Threshold-Based Spatio-Temporal Attention Networks,” IEEE Transactions on Mobile Computing (TMC), vol. 25, no. 1, pp. 483-499, 2026.
