...
links:
  - type: pdf
    url: "/papers/2019-robust-spinning-sensing-with-dual-rfid-tags-in-noisy-settings.pdf"
hugoblox:
  ids:
...
Conventional spinning inspection systems, equipped with separated sensors (e.g., accelerometer, laser, etc.)
...
spinning signal using dual tags' readings and analytically demonstrate its feasibility in various settings.
...
Experimental results show that Tagtwins can inspect the rotation frequency with high accuracy and robustness.
